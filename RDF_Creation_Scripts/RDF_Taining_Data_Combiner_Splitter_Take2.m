...
ring_search_string = string(ring_search) + "_c_";
...
export_dir = export_dir + "/chan_" + string(ring_search) + "_" + string(tag) + "_" + string(time_now);
...
% asph_dir_1 = '/media/autobuntu/chonk/chonk/git_repos/PCD_STACK_RDF_CLASSIFIER/TRAINING_DATA/01_RDF_Training_Data_Extraction_Export/asphalt_2';
grav_dir_1 = '/media/autobuntu/chonk/chonk/git_repos/PCD_STACK_RDF_CLASSIFIER/TRAINING_DATA/01_RDF_Training_Data_Extraction_Export/gravel';
...
grav_train_fn   = export_dir + "/grav_train_chan"   + string(ring_search) + ".csv";
...
grav_test_fn    = export_dir + "/grav_test_chan"    + string(ring_search) + ".csv";
% foli_test_fn    = export_dir + "/foli_test_chan"    + string(ring_search) + "_" + string(time_now) + ".csv";

train_all_fn    = export_dir + "/train_all_chan"    + string(ring_search) + ".csv";
test_all_fn     = export_dir + "/test_all_chan"     + string(ring_search) +".csv";
