...
num_terrain = size_tester_table(1) / 2;
...
%             {'gravel'}    3,3
        ...
        grav_err_array          = [grav_err_array; (RDF_RESULTS.NumTrees) (1 - RDF_CONF_MAT(2,2) / num_terrain)];
...
if save_plt_bool
    ...
    try
        ...
        saveas(asph_plt, string(results_folder) + '/asph_plt.png', 'png');
...
%         saveas(asph_false_neg_plt, string(results_folder) + '/asph_false_neg_array.png', 'png');
