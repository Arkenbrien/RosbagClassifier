...
function table_export = getallfeats(xyzi, abcd)
    
    %% Table Header
    table_head = {'StandDevHeight',...
    'RoughnessHeight',...
    'MinMaxRatioHeight',...
    'Min2MaxRatioHeight',...
    'MagGradientHeight',...
    ...
    data_data = [std(height),...
	max(height) - min(height),...
	min(height) / max(height),...
	min(height)^2 / max(height),...
	sqrt(sum(gradient(height).^2)),...
	std(height) / xy_dist,...
	(max(height) - min(height)) / xy_dist,...
	(min(height) / max(height))/ xy_dist,...
	(min(height)^2 / max(height))/ xy_dist,...
	sqrt(sum(gradient(height).^2)) / xy_dist,...
	std(height) / range_mean,...
	(max(height) - min(height)) / range_mean,...
	(min(height) / max(height))/ range_mean,...
	(min(height)^2 / max(height))/ range_mean,...
	sqrt(sum(gradient(height).^2)) / range_mean,...
	std(range),...
	max(range) - min(range),...
	min(range) / max(range),...
	...
	std(range) / xy_dist,...
	(max(range) - min(range)) / xy_dist,...
	(min(range) / max(range)) / xy_dist,...
	(min(range)^2 / max(range)) / xy_dist,...
	...
	std(xyzi(:,3)) / range_mean,...
	(max(xyzi(:,3)) - min(xyzi(:,3))) / range_mean,...
	(min(xyzi(:,3)) / max(xyzi(:,3))) / range_mean,...
