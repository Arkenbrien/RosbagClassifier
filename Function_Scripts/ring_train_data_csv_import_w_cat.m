...
opts.VariableNames = ["StandDevRange", "RoughnessRange", "MinMaxRatioRange", "Min2MaxRatioRange", "MagGradientRange", "StandDevInt", "RangeInt", "MedMaxRatioInt", "Med2MaxRatioInt", "MagGradientInt", "terrain_type"];
