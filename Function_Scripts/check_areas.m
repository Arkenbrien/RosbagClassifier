...
%     tformed_area = tformed_r;
    ...
    c2_sum = length(c2g_indices) + length(c2a_indices) + length(c2u_indices);
    c3_sum = length(c2g_indices) + length(c2a_indices) + length(c2u_indices);
    c4_sum = length(c2g_indices) + length(c2a_indices) + length(c2u_indices);
...
%                 elseif  isempty(c3u_indices) && isempty(c4u_indices)
                elseif  isempty(c4u_indices)
...
%                     area_export.clas    = 'unknown';
            ...
            elseif tot_asph_percent > 65.0
                ...
                if isempty(c3a_indices) && isempty(c4a_indices)
                    
                    area_export.area    = tformed_area;
                    area_export.clas    = 'unknown';
                    
                elseif ~isempty(c2a_indices) && ~isempty(c3a_indices) && ~isempty(c4a_indices)
...
%                 end
        ...
        area_export.points              = [NaN, NaN, NaN];
        area_export.tot_percent         = [0, 0, 0];
        area_export.grav_points         = [NaN, NaN, NaN];
        area_export.asph_points         = [NaN, NaN, NaN];
        area_export.unkn_points         = [NaN, NaN, NaN];
        area_export.Slope_c24           = NaN;
        area_export.Slope_c24_minmax    = NaN;
