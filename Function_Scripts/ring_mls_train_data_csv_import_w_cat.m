function data_import = ring_mls_train_data_csv_import_w_cat(filename)
...
opts.VariableNames = ["StandDevHeightMLS", "RoughnessHeightMLS", "MinMaxRatioHeightMLS", "Min2MaxRatioHeightMLS", "MagGradientHeightMLS", "StandDevInt", "MeanInt", "RangeInt", "MedMaxRatioInt", "Med2MaxRatioInt", "MagGradientInt", "terrain_type"];
